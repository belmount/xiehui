...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { category: @banner.category, desc: @banner.desc, expire_at: @banner.expire_at, img: @banner.img, link: @banner.link, start_at: @banner.start_at }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { category: @banner.category, desc: @banner.desc, expire_at: @banner.expire_at, img: @banner.img, link: @banner.link, start_at: @banner.start_at }
    assert_redirected_to banner_path(assigns(:banner))
  end
